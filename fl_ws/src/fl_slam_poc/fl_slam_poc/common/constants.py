...
Golden Child SLAM v2 constants are in Section: GOLDEN CHILD MANIFEST CONSTANTS
...
GC_ANCHOR_DRIFT_A = 10.0  # Pose norm sigmoid steepness (legacy)
GC_ANCHOR_DRIFT_C0 = 1e4  # Condition number threshold center (legacy)
GC_ANCHOR_DRIFT_B = 1.0  # Condition sigmoid steepness (legacy)
GC_ANCHOR_DRIFT_S0 = 0.8  # Support fraction threshold center (legacy)
GC_ANCHOR_DRIFT_D = 5.0  # Support sigmoid steepness (legacy)
