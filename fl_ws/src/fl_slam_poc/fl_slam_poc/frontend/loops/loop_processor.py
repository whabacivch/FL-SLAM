...
from fl_slam_poc.frontend.loops.pointcloud_gpu import GPUPointCloudProcessor, is_gpu_available
...
from fl_slam_poc.common.transforms.se3 import se3_compose, se3_inverse
...
class LoopProcessor:
    ...
    def compute_responsibilities(self,
                                ...
                                base_weight: float) -> Tuple[Dict[int, float], float]:
        """
        ...
        Returns:
            (responsibilities, r_new): Dict of anchor responsibilities and new-component responsibility
        """
        if len(anchors) == 0:
        ...
        return responsibilities, new_comp_resp
