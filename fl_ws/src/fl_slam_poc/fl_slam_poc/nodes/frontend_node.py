...
from fl_slam_poc.frontend import SensorIO, DescriptorBuilder, AnchorManager, LoopProcessor
from fl_slam_poc.utils import StatusMonitor, SensorStatus
from fl_slam_poc.models import (
    AdaptiveParameter,
    TimeAlignmentModel,
    StochasticBirthModel,
)
from fl_slam_poc.operators import OpReport, make_evidence, vmf_make_evidence
from fl_slam_poc.geometry.se3 import rotmat_to_quat, rotvec_to_rotmat, se3_compose
...
class Frontend(Node):
    ...
    def _init_modules(self):
        ...
        self.loop_processor = LoopProcessor(
            fr_distance_scale, icp_max_iter, icp_tol, icp_n_ref, icp_sigma_mse)
