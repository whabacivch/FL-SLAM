"""
LiDAR (line,tag) bucket measurement-noise IW state for GC v2 (arrays-only).

This is Phase 3 part 2: a fixed bucket table with K = N_LINES * N_TAGS states.
No dicts, no dynamic shapes.
"""
...
def create_datasheet_lidar_bucket_noise_state() -> LidarBucketNoiseIWState:
    """
    ...
    Sigma0 = float(C.GC_LIDAR_SIGMA_MEAS) * jnp.eye(3, dtype=jnp.float64)
