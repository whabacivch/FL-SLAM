"""
Legacy constants retained for reference only.

This file is archived and MUST NOT be imported by runtime entrypoints.
Active Golden Child SLAM v2 constants live in
`fl_slam_poc/common/constants.py`.
"""
